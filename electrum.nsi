...
Section
  ...
  CreateShortCut "$DESKTOP\Electrum.lnk" "$INSTDIR\electrum-cryp.exe" ""
  ...
  CreateShortCut "$SMPROGRAMS\Electrum\Electrum.lnk" "$INSTDIR\electrum-cryp.exe" "" "$INSTDIR\electrum-cryp.exe" 0
