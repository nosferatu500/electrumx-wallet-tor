...
buildOptions = dict(packages = ["idna","shutil","ltc_scrypt","argparse","dns", "lib", "gui","dbhash","dumbdbm","ConfigParser","mmap","plugins"], excludes = [], include_files=["lib","electrum-xvg.conf"])
