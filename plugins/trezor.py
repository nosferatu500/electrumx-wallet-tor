...
class TrezorWallet(BIP32_HD_Wallet):
    ...
    def show_address(self, address):
        ...
        try:
            ...
            give_error(e)
        try:
            self.get_client().get_address('CrypricCoin', address_n, True)
        except Exception, e:
            give_error(e)
        finally:
    ...
    def sign_message(self, address, message, password):
        ...
        try:
            ...
            give_error(e)
        try:
            msg_sig = self.get_client().sign_message('CrypricCoin', address_n, message)
        except Exception, e:
            give_error(e)
        finally:
            self.plugin.handler.stop()
    ...
    def sign_transaction(self, tx, password):
        ...
        try:
            signed_tx = self.get_client().sign_tx('CrypricCoin', inputs, outputs)[1]
        except Exception, e:
            give_error(e)
        finally:
            self.plugin.handler.stop()
