...
from electrum_cryp.bitcoin import is_valid
...
import re
import time
from electrum_cryp.wallet import Wallet, WalletStorage
import webbrowser
...
from electrum_cryp.version import ELECTRUM_VERSION as electrum_version
from electrum_cryp.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a CrypticCoin address or contact"))
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your CrypticCoin address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive CrypticCoin payment"))
