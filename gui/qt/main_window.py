...
from electrum_cryp.bitcoin import MIN_RELAY_TX_FEE, COIN, is_valid
from electrum_cryp.plugins import run_hook
from electrum_cryp.i18n import _
from electrum_cryp.util import block_explorer, block_explorer_info, block_explorer_URL
from electrum_cryp.util import print_error, print_msg
from electrum_cryp.util import format_satoshis, format_satoshis_plain, format_time, NotEnoughFunds, StoreDict
from electrum_cryp import Transaction
from electrum_cryp import mnemonic
from electrum_cryp import util, bitcoin, commands, Wallet
from electrum_cryp import SimpleConfig, Wallet, WalletStorage
from electrum_cryp import Imported_Wallet
from electrum_cryp import paymentrequest
from electrum_cryp.contacts import Contacts
...
from electrum_cryp import ELECTRUM_VERSION
import re
...
from electrum_cryp.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
from electrum_cryp.paymentrequest import PaymentRequest, InvoiceStore, get_payment_request
...
class ElectrumWindow(QMainWindow):
    ...
    def __init__(self, config, network, gui_object):
        ...
        self.setWindowIcon(QIcon(":icons/electrum-cryp.png"))
        self.init_menubar()
    ...
    def show_about(self):
        QMessageBox.about(self, "Electrum-CRYP",
            _("Version")+" %s" % (self.wallet.electrum_version) + "\n\n" + _("Electrum's focus is speed, with low resource usage and simplifying CrypticCoin. You do not need to perform regular backups, because your wallet can be recovered from a secret phrase that you can memorize or write on paper. Startup times are instant because it operates in conjunction with high-performance servers that handle the most complicated parts of the CrypticCoin system."))
    ...
    def create_receive_tab(self):
        ...
        msg = _('CrypticCoin address where the payment should be received. Note that each payment request uses a different CrypticCoin address.')
        ...
        msg = ' '.join([
            ...
            _('Expired requests have to be deleted manually from your list, in order to free the corresponding CrypticCoin addresses'),
        ])
    ...
    def create_send_tab(self):
        ...
        msg = _('Recipient of the funds.') + '\n\n'\
              + _('You may enter a CrypticCoin address, a label from your list of contacts (a list of completions will be proposed), or an alias (email-like address that forwards to a CrypticCoin address)')
        ...
        msg = _('CrypticCoin transactions are in general not free. A transaction fee is paid by the sender of the funds.') + '\n\n'\
    ...
    def read_send_tab(self):
        ...
        for _type, addr, amount in outputs:
            if addr is None:
                QMessageBox.warning(self, _('Error'), _('CrypticCoin Address is None'), _('OK'))
                return
            if _type == 'address' and not bitcoin.is_address(addr):
                QMessageBox.warning(self, _('Error'), _('Invalid CrypticCoin Address'), _('OK'))
                return
            if amount is None:
    ...
    def pay_to_URI(self, URI):
        ...
        try:
            ...
            QMessageBox.warning(self, _('Error'), _('Invalid CrypticCoin URI:') + '\n' + str(e), _('OK'))
            return
        self.tabs.setCurrentIndex(1)
    ...
    def read_tx_from_qrcode(self):
        from electrum_cryp import qrscanner
        try:
    ...
    def export_privkeys_dialog(self, password):
        ...
        defaultname = 'electrum-cryp-private-keys.csv'
    ...
    def do_export_labels(self):
        ...
        try:
            fileName = self.getSaveFileName(_("Select file to save your labels"), 'electrum-cryp_labels.dat', "*.dat")
            if fileName:
                with open(fileName, 'w+') as f:
                    json.dump(labels, f)
    ...
    def export_history_dialog(self):
        ...
        vbox = QVBoxLayout(d)
        defaultname = os.path.expanduser('~/electrum-cryp-history.csv')
    ...
    def settings_dialog(self):
        ...
        from electrum_cryp.i18n import languages
    ...
    def plugins_dialog(self):
        from electrum_cryp.plugins import plugins, descriptions, is_available, loader
    ...
    def create_csr(self, alias, challenge, password):
        from electrum_cryp import x509
        import tlslite
