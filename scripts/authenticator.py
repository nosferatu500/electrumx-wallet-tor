...
from electrum_cryp import SimpleConfig, Wallet, WalletStorage, format_satoshis
from electrum_cryp import util
from electrum_cryp.transaction import Transaction
from electrum_cryp.bitcoin import base_encode, base_decode
    ...
    content = """
      ...
      <LinearLayout 
        ...
        <TextView
          ...
          android:text="Electrum- CRYPAuthenticator"
...
class Authenticator:
    ...
    def __init__(self):
        global wallet
        self.qr_data = None
        storage = WalletStorage('/sdcard/electrum-cryp/authenticator')
